  ...
  try {
    ...
    const response = await useFetch('/api/register-user', {
      ...
      body: {
        ...
        profilePicture: profilePictureUrl.value && profilePictureUrl.value.length > 0 ? profilePictureUrl.value : '/assets/img/avatar.jpg',
        background: backgroundPictureUrl.value && backgroundPictureUrl.value.length > 0 ? backgroundPictureUrl.value : '/assets/img/empty-background.jpg',
        link: '',
        validUntil: '',
        volume: 0,
        used: 0,
