<template>
  <div>
    ...
    <div v-if="progress.totalFiles > 0">
      <p>Processing {{ progress.processedFiles }} of {{ progress.totalFiles }} files...</p> <!-- Fortschrittsanzeige für die einuzelnen Uploads -->
    </div>
    ...
    async handleFileUpload(event) { // Aufruf der Funktion
      ...
      for (const file of files) {
        ...
        try {
          ...
          // Pushing each response to the compressionResults array
          this.compressionResults.push(response.data[0]);
